...
class atlas(Base):
    ...
    def run(self):
        ...
        # given wrapper.py is not located anymore in the current directory
        # but it is where pilot.py has been downloaded,
        # first we add the current directory to sys.path 
